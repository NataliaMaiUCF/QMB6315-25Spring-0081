...
cur.execute('SELECT * FROM state_population')
...
cur.execute('SELECT population FROM state_population')
for row in cur.fetchall():
 print(row)
...
cur.execute('SELECT state FROM state_population WHERE population < 1000000')
for row in cur.fetchall():
 print(row)
...
cur.execute('SELECT state FROM state_population WHERE population < 1000000 OR population > 5000000' )
for row in cur.fetchall():
 print(row)
...
cur.execute('SELECT state FROM state_population WHERE population >= 1000000 AND population <= 5000000')
for row in cur.fetchall():
 print(row)
...
cur.execute('''SELECT Density.Area
 FROM Capitals INNER JOIN Density
 ON Capitals.State = Density.State
